...
--
-- 本 SQL 只建：
--   1. system_tenant (id=999, name=拓小二平台)
...
--   4. shop_info (tenant=999, shop_name=拓小二平台, status=1)
...
VALUES (999, '拓小二平台', '平台运营', '15928962028', 0, '', 0, '2099-12-31 23:59:59', 100, '1', NOW(), '1', NOW(), b'0');
...
VALUES (999, '拓小二平台', '平台运营', '15928962028', 1, 999, 999, b'1', NULL, 'PLATFORM', 99999, NOW(), NOW(), b'0');
...
VALUES (999, 999, '拓小二平台', 1, 5.0, 0, 0, b'1', 2, b'1', 'SM2', NOW(), NOW(), b'0');
