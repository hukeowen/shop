  ...
  <view class="page">
      ...
      >
        ...
        <view class="center">
          ...
          <view class="stats">
            ...
            <text>消费 <text class="em">{{ Math.floor((s.points || 0) / 100) }} 积分</text></text>
          </view>
        </view>
    ...
    <view class="me-grid">
      ...
      <view class="me-row" @click="goQueue">
        ...
        <text class="me-row-name">我的队列（邀请激励）</text>
    ...
    <RoleTabBar current="/pages/user-me/index" force-role="member" />
  </view>
</template>
